...
# Genetic correlation and heritability - LDSC output

If `--post_analysis` option was provided with input `heritability` or `genetic_correlation_h2`, then the output can be found as a text file in `Results` tab -> `results/` -> `heritability` or `genetic_correlation` folder, respectively. 