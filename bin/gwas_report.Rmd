...
```{r, comment=''}
if(params$ldsc_log != "None"){

cat(readLines(params$ldsc_log), sep = '\n')

}
if(params$ldsc_log == 'None'){
cat(print('No post analysis selected. If you want to run heritability and genetic correlation, please provide --post_analysis param.'))
}
